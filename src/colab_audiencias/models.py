...
class AudienciasBill(models.Model):
...
class AudienciasSegmentType(models.Model):

    id = models.IntegerField(primary_key=True)
    name = models.CharField(max_length=999)


class AudienciasSegment(models.Model):

    id = models.IntegerField(primary_key=True)
    bill = models.ForeignKey('AudienciasBill', related_name='segments')
    ...
    type = models.ForeignKey('AudienciasSegmentType')
...
class AudienciasComment(models.Model):
    ...
    def get_parent_object(self):
        ...
        if self.content_type == 'segment':
            parent_obj = AudienciasSegment.objects.get(pk=self.object_pk)
